...
function validateLoginForm(form) {
  ...
  for (let field of requiredFields) {
    if (!form[field].value) {
      alert(`${fieldNames[field]}Î•??ÖÎ†•?òÏÑ∏??`);
      form[field].focus();
      return false;
    }
  }
...
function validateRegisterForm(form) {
  ...
  if (form['pass'].value !== form['pass_confirm'].value) {
    alert("ÎπÑÎ?Î≤àÌò∏Í∞Ä ?ºÏπò?òÏ? ?äÏäµ?àÎã§.\n?§Ïãú ?ÖÎ†•??Ï£ºÏÑ∏??");
    form['pass'].focus();
    form['pass'].select();
    return false;
  }
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-login">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-xs-6">
                            <a href="login_form.php" class="active" id="login-form-link">Î°úÍ∑∏??/a>
                        </div>
                        <div class="col-xs-6">
                            <a href="member_form.php" id="register-form-link">?åÏõêÍ∞Ä??/a>
                        </div>
                    </div>
                    <hr>
                </div>
                        ...
                        <div class="col-lg-12">
                            <form id="login-form" name="login_form" method="post" action="login.php" role="form" style="display: block;">
                                <div class="form-group">
                                    <input type="text" name="id" id="userID" tabindex="1" class="form-control" placeholder="?ÑÏù¥?? value="">
                                </div>
                                <div class="form-group">
                                    <input type="password" name="pass" id="password" tabindex="2" class="form-control" placeholder="ÎπÑÎ?Î≤àÌò∏">
                                </div>
                                <div class="form-group text-center">
                                    <input type="checkbox" tabindex="3" class="" name="remember" id="remember">
                                    <label for="remember">?ÑÏù¥??Í∏∞Ïñµ?òÍ∏∞</label>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
                                            <input type="button" onclick="check_login()" name="login-submit" id="login-submit" tabindex="4" class="form-control btn btn-login" value="Î°úÍ∑∏??>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="text-center">
                                                <a href="find_password_form.php" tabindex="5" class="forgot-password">ÎπÑÎ?Î≤àÌò∏Î•??äÏñ¥Î≤ÑÎ¶¨?®ÎÇò??</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
