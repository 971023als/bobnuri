...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_CANNOT_DROP        => 'kan inte sl?pa',
            DB_ERROR_CONSTRAINT         => 'begr?sning kr?kt',
            ...
            DB_ERROR_NOSUCHFIELD        => 'inget s?ant f?t',
            DB_ERROR_NOSUCHTABLE        => 'ingen s?an tabell',
            DB_ERROR_NOT_CAPABLE        => 'DB backend klarar det inte',
            DB_ERROR_NOT_FOUND          => 'finns inte',
            DB_ERROR_NOT_LOCKED         => 'inte l?t',
            DB_ERROR_SYNTAX             => 'syntaxfel',
            DB_ERROR_UNSUPPORTED        => 'st?s ej',
            DB_ERROR_VALUE_COUNT_ON_ROW => 'v?de r?nat p?rad',
            DB_ERROR_INVALID_DSN        => 'ogiltig DSN',
            DB_ERROR_CONNECT_FAILED     => 'anslutning misslyckades',
            0	                       => 'inget fel', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'otillr?kligt med data angivet',
            DB_ERROR_EXTENSION_NOT_FOUND=> 'ut?ning hittades ej',
            DB_ERROR_NOSUCHDB           => 'ingen s?an databas',
            DB_ERROR_ACCESS_VIOLATION   => 'otillr?kliga r?tigheter'
);
?>