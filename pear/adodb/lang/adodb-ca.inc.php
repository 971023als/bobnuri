...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_INVALID            => 'no ? v?id',
            DB_ERROR_INVALID_DATE       => 'la data o l\'hora no s? v?ides',
            DB_ERROR_INVALID_NUMBER     => 'el nombre no ? v?id',
            DB_ERROR_MISMATCH           => 'no hi ha coincid?cia',
            ...
            DB_ERROR_NOT_CAPABLE        => 'l\'execuci?secund?ia de DB no pot',
            ...
            DB_ERROR_INVALID_DSN        => 'el DSN no ? v?id',
            DB_ERROR_CONNECT_FAILED     => 'connexi?fallida',
            0	                       => 'cap error', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => 'les dades subministrades s? insuficients',
