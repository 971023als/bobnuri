      ...
      <table border="0" cellspacing="50" cellpadding="10">
        <tr>
          ...
          <td><b><?=$product_name?></b><br><br>
                  ...
                  <tr>
        <button type="button" onclick="location.href='point_mall_index.php'"><b>Î™©Î°ù?ºÎ°ú</b></button>
        </tr>
        <?php
            if ($userlevel == 100) {
                $num = $_GET["num"] ?? "";
        ...
        ?>
        <tr>
        <button type="button" onclick="location.href='point_mall_modify_form.php?num=<?=$num?>'"><b>?òÏ†ï</b></button> 
        </tr>
        <tr>
        <button type="button" onclick="location.href='point_mall_delete.php?num=<?=$num?>'"><b>??†ú</b></button>  
        </tr>
        <tr>
        <button type="button" onclick="location.href='point_mall_insert_form.php'"><b>Ï∂îÍ?</b></button>
        </tr>
        <?php
            }
        ?>
